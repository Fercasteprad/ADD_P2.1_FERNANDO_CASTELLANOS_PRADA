<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="dam2.add.p21.model.Usuario"%>
		     ...
		     <div class="row mx-auto">
			     <form class="row mx-auto justify-content-center align-items-center" action="<%=request.getContextPath()%>/" method="post">
			         ...
			         <div class="col-xl-6 justify-content-center align-items-center">
                         ...
                         <input class="form-control" type="number" required name="telefonoEdit" placeholder="<%=rb.getString("telefono")%>" value="<%=user.getTelefono()%>"><br>
                     </div>
